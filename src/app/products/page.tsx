...
export const metadata: Metadata = {
  title: 'Products & Services | MigoLoop',
  description: 'Explore our products and health care services designed to deliver exceptional care and improve outcomes.',
  keywords: 'medical products, medical devices, healthcare services, patient care, MigoLoop',
  openGraph: {
    title: 'Products & Services | MigoLoop',
    description: 'Explore our products and health care services designed to deliver exceptional care and improve outcomes.',
    type: 'website',
